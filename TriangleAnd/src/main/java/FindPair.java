...
public class FindPair {
    public static class FindPairMapper
    ...
    public static class FindPairCombiner
    ...
    public static class FindPairNewPartitioner
    ...
    public static class FindPairReducer
    ...
    public static void main(String inputPath, String outBufPath) throws Exception{
        ...
        Job job = Job.getInstance(conf, "FindPair");
        job.setJarByClass(FindPair.class);
        job.setMapperClass(FindPairMapper.class);
        job.setCombinerClass(FindPairCombiner.class);
        job.setPartitionerClass(FindPairNewPartitioner.class);
        job.setReducerClass(FindPairReducer.class);
